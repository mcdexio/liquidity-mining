...
ZHOU_REWARD_COMP_POOL_BLOCK_NUMBER =  os.environ.get('ZHOU_REWARD_COMP_POOL_BLOCK_NUMBER', 10742700)
ZHOU_REWARD_LEND_POOL_BLOCK_NUMBER =  os.environ.get('ZHOU_REWARD_LEND_POOL_BLOCK_NUMBER', 10742700)
ZHOU_REWARD_SNX_POOL_BLOCK_NUMBER =  os.environ.get('ZHOU_REWARD_SNX_POOL_BLOCK_NUMBER', 10742700)

# QIN
QIN_BEGIN_BLOCK_NUMBER =  os.environ.get('QIN_BEGIN_BLOCK_NUMBER', 10830000)
QIN_M = 4
QIN_N = 615000

QIN_REWARD_BTC_POOL_BLOCK_NUMBER =  os.environ.get('QIN_REWARD_BTC_POOL_BLOCK_NUMBER', 12000000)
