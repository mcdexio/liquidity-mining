...
# SHANG
SHANG_REWARD_LINK_POOL_BLOCK_NUMBER =  os.environ.get('SHANG_REWARD_LINK_POOL_BLOCK_NUMBER', 10800000)
SHANG_REWARD_BTC_POOL_BLOCK_NUMBER =  os.environ.get('SHANG_REWARD_BTC_POOL_BLOCK_NUMBER', 10800000)
