...
# watcher
WATCHER_CHECK_INTERVAL = int(os.environ.get('WATCHER_CHECK_INTERVAL', 30)) # 30 sec
...
QIN_REDUCE_REWARD_BLOCK_NUMBER =  os.environ.get('QIN_REDUCE_REWARD_BLOCK_NUMBER', 10838800)
...
# UNISWAP_MCB/USDC
UNISWAP_MCB_USDC_SHARE_TOKEN_ADDRESS = os.environ.get('UNISWAP_MCB_USDC_SHARE_TOKEN_ADDRESS', '0x4c508567eaea699f61483c933184d351e7ecb862')
