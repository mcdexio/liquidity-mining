...
XIA_PERPETUAL_ADDRESS = os.environ.get('XIA_PERPETUAL_ADDRESS', '0x220a9f0dd581cbc58fcfb907de0454cbf3777f76')
XIA_PERPETUAL_INVERSE = os.environ.get('XIA_PERPETUAL_INVERSE', True)
